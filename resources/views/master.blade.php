...
<head>
    ...
    <title>SB Admin2 Laravel 5</title>
...
<body>
    ...
    <script src="{{ asset('assets/admin/vendor/flot/excanvas.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/admin/vendor/flot/jquery.flot.resize.js') }}s"></script>
    <script src="{{ asset('assets/admin/vendor/flot/jquery.flot.time.js') }}"></script>
    <script src="{{ asset('assets/admin/vendor/flot-tooltip/jquery.flot.tooltip.min.js') }}"></script>
    <script src="{{ asset('assets/admin/data/flot-data.js') }}"></script>
